      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={notifRef}>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute top-0 right-0 w-4 h-4 bg-brand-red text-white text-[10px] font-bold flex items-center justify-center rounded-full border border-white">
            ...
            {showNotifications && (
              ...
              >
                <div className="px-4 py-3 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                  ...
                  {unreadCount > 0 && (
                    <span className="text-xs font-semibold text-brand-red bg-red-50 px-2 py-1 rounded-full">
                      {unreadCount} New
                    </span>
                  )}
                </div>
                  ...
                  {notifications.length > 0 ? (
                    notifications.map((notif) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-8 h-8 rounded-full bg-brand-red/10 text-brand-red flex items-center justify-center shrink-0 mt-1">
                            <FiMessageSquare />
                          </div>
                ...
                {notifications.length > 0 && (
                  <button 
                    onClick={handleNotificationClick}
                    className="w-full p-3 text-center text-sm font-bold text-brand-red hover:bg-red-50 transition-colors border-t border-slate-100"
                  >
                    View All Messages
                  </button>
                )}

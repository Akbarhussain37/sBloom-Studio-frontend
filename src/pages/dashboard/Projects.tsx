        ...
        <div className="bg-[#F7F9FC] border border-slate-200 p-6 rounded-[1.5rem] mb-6">
          ...
          <form onSubmit={handleCreateProject} className="flex gap-4">
            <input 
              ...
              className="flex-1 px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-brand-red focus:border-brand-red transition-all"
              autoFocus
            />
